...
function StatCard({ icon: Icon, label, value, iconColor, iconBg, valueColor, loading }: StatCardProps) {
  return (
...
function QuickAction({ to, icon: Icon, label, iconColor, iconBg }: QuickActionProps) {
  return (
    <Link
      to={to}
